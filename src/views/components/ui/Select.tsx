    ...
    return (
      <div className="relative">
        ...
        <select
          ...
          className={cn(
            'bg-white border border-gray-300 text-sm rounded-[2px] block w-full p-2.5 focus:border-gray-400 transition-all outline-none appearance-none cursor-pointer',
